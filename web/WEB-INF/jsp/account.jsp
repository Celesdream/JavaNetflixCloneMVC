...
<li class="nav-item">
  <a class="nav-link text-white " href="<c:url value="/misFavoritos.do" />">
    ...
    <span class="nav-link-text ms-1">Mis Favoritos</span>
  </a>
</li>

  
  <li class="nav-item">
  <a class="nav-link text-white " href="<c:url value="/listadoCC.do" />">
  ...
  <li class="nav-item">
  <a class="nav-link text-white " href="<c:url value="/editarCuenta.do" />">
    
      <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
        <i class="material-icons opacity-10">account_box</i>
      </div>
    
    <span class="nav-link-text ms-1">Editar Cuenta</span>
  </a>
</li>
...
<div class="row">
  ...
  <h2 class="font-weight-bolder mb-0">Hi! ${user.nombre} <td></td></h2>
  ...
  <div class="card-header p-3 pt-2">
    ...
    <div class="text-end pt-1">
      <p class="text-sm mb-0 text-capitalize">Tipo de Cuenta</p>
      <h4 class="mb-0">${user.premium}</h4>
    </div>
  </div>
