...
<html lang="en">
  ...
  <body>
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-12 col-sm-8 col-md-6 col-lg-4 offset-sm-2 offset-md-3 offset-lg-4">
            ...
            <h1 class="mb-3 text-center">Bienvenido al Registro de Nuevas Peliculas</h1>
                                  

            <p class="lead">
              Añade nuevas peliculas a nuestro catalogo
            </p>
            ...
            <form class="mb-3">
              ...
              <button type="click" class="btn btn-primary btn-block mb-3" id="finala">
                Crear Pelicula
              </button>
    ...
    <script
      ...
      crossorigin="anonymous"
    ></script>
    <script src="<c:url value="/public/js/master/nuevaPelicula.js"/>"></script>
  </body>
